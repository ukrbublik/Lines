...
// Make compatible with ToolTips (by BUBLiK)
#define __COMPATIBLE_WITH_TOOLTIPS__

class CButtonST : public CButton
{

#ifdef __COMPATIBLE_WITH_TOOLTIPS__
	friend class CPPToolTip;
#endif //__COMPATIBLE_WITH_TOOLTIPS__

#ifdef __COMPATIBLE_WITH_TOOLTIPS__
	BOOL m_bIsCoveredByToolTip;
#endif //__COMPATIBLE_WITH_TOOLTIPS__
...
public:
	void CancelHover(BOOL bInvalidate = TRUE);
private:
